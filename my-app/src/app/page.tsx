...
return (
  <>
    ...
    <main className="min-h-screen  bg-white bg-[url('/grid-bg.png')] bg-repeat p-6"  >
      <h1 className="text-5xl font-bold text-center text-blue-700  " style={{ letterSpacing:5}}>
        ResumeTailor
      </h1>
      <p className="text-center mb-12" style={{  color: '#ffb926', fontWeight: 400, fontStyle:"italic", fontSize:19 ,fontFamily:"cursive"   }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] items-center gap-6 px-6 md:px-12 py-10"  style={{ backgroundColor:"#146C94"}}>
        ...
        <div className="text-center p-8" >
          <p className="text-3xl font-semibold whitespace-nowrap mb-8 text-white "  >
